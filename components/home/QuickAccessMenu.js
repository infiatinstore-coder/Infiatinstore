        ...
        <div className="flex justify-between md:justify-around overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 hide-scrollbar gap-4 md:gap-8 pt-2">
            {menuItems.map((item, index) => (
                ...
                >
                    ...
                    <span className="text-[10px] md:text-xs text-center font-medium text-gray-700 group-hover:text-primary-600 transition-colors leading-tight line-clamp-2 w-full max-w-[80px]">
                        {item.label}
                    </span>
                </Link>
            ))}
