...
import { Search, Filter, Star, ShoppingCart, Heart, X, SlidersHorizontal } from 'lucide-react';
            ...
            <div className="container-app py-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-neutral-500">{filteredProducts.length} produk ditemukan</p>
                    </div>
...
export default function SearchPage() {
    return (
        <>
            <Header />
            <CartDrawer />
            <Suspense fallback={<div className="flex-1 bg-neutral-50 flex items-center justify-center">Loading...</div>}>
                <SearchContent />
            </Suspense>
            <Footer />
        </>
