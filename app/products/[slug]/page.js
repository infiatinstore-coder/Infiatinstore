...
import { ShoppingCart, Heart, Share2, Star, Truck, Shield, RotateCcw, Minus, Plus, ChevronLeft, ChevronRight, MessageCircle, Store, Ticket, X, Check } from 'lucide-react';
...
export default function ProductDetailPage() {
    ...
    const soldCount = product.soldCount || product.reviewCount * 10 || 100;
                        ...
                        <div className="lg:col-span-2 bg-white lg:bg-transparent">
                            <div className="p-4 lg:p-0 space-y-4">
                                ...
                                <div className="flex items-center gap-3 text-sm">
                                    ...
                                    <span className="text-neutral-500">{product.reviewCount} Penilaian</span>
                                    <span className="text-neutral-300">|</span>
                        ...
                        <div className="hidden lg:block lg:col-span-1">
                            <div className="sticky top-24 bg-white rounded-lg p-4 border border-neutral-200">
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="text-lg font-bold text-neutral-800">{formatRupiah(currentPrice * quantity)}</span>
                                </div>
