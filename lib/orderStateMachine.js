    ...
    switch (toStatus) {
        case 'PAID':
            ...
            try {
                ...
                await reduceStock(items, order.id, order.user_id);
        ...
        case 'CANCELLED':
            ...
            if (['PAID', 'PROCESSING'].includes(fromStatus)) {
                ...
                await restoreStock(items, order.id, 'ORDER_CANCELLED', order.user_id);
            }
        ...
        case 'REFUNDED':
            ...
            await restoreStock(refundItems, order.id, 'RETURN', order.user_id);
            break;
