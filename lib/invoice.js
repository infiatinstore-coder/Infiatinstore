...
export function generateInvoiceHTML(order) {
    ...
    <body>
        ...
        <div class="info-section">
            <div class="info-box">
                <h3>Dari</h3>
                <p><strong>infiya.store</strong></p>
                <p>Email: support@infiya.store</p>
        ...
        ${order.shippingMethod ? `
            <div class="notes">
                ...
                ${order.trackingNumber ? `<p>No. Resi: <strong>${order.trackingNumber}</strong></p>` : ''}
            </div>
        ` : ''}
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px; color: #999;">© 2024 infiya.store - Semua Hak Dilindungi</p>
        </div>
