...
const ALERT_EMAIL = process.env.ALERT_EMAIL || 'admin@infiya.store';
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || 'alert@infiya.store';
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="border: 2px solid ${color}; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
        ...
        <p style="color: #6B7280; font-size: 14px; margin-top: 20px;">
            ...
            <strong>System:</strong> infiya.store Production
        </p>
    </div>
    
    <p style="color: #9CA3AF; font-size: 12px; text-align: center; margin-top: 20px;">
        This is an automated alert from infiya.store monitoring system.
    </p>
</body>
</html>
    `;
    ...
    try {
        await resend.emails.send({
            from: FROM_EMAIL,
            to: ALERT_EMAIL,
            subject: `🚨 [${severity}] ${title} - infiya.store`,
            html: htmlContent
        });
