        ...
        <Link href={`/products/${product.slug}`}>
            <article className={cn(
                ...
                <div className="relative aspect-square overflow-hidden bg-neutral-50">
                    ...
                    {discountPercentage > 0 && (
                        <div className="absolute top-0 right-0 z-10">
                            <div className="bg-[#EE4D2D] text-white text-[9px] font-bold px-1.5 py-0.5 rounded-bl-lg shadow-sm leading-none flex flex-col items-center justify-center min-w-[28px] h-[32px]">
                ...
                <div className="p-1.5 md:p-2">
                    {/* Name - 2 lines, very tight */}
                    <h3 className="text-[11px] md:text-sm font-normal text-[#212121] line-clamp-2 mb-0.5 leading-snug min-h-[1.6rem]">
                        {product.name}
                    </h3>

                    {/* Price */}
                    <div className="flex items-baseline gap-1 mb-1 flex-wrap">
                        <span className="text-sm md:text-lg font-bold text-[#EE4D2D]">
